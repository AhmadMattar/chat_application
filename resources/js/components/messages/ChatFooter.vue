    ...
    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
        ...
        <form class="chat-form rounded-pill bg-dark" data-emoji-form="" method="post" action="/api/messages" @submit.prevent="sendMessage()">
            ...
            <div class="row align-items-center gx-0">
                <div class="col-auto">
                    <a href="#" @click.pervent="selectFile()" class="btn btn-icon btn-link text-body rounded-circle" id="dz-btn">
                ...
                <div class="col">
                    <div class="input-group">
                        <textarea class="form-control px-0" name="message" v-model="message" @keypress="isTyping()" @focus="$root.markAsRead()" placeholder="Type your message..." rows="1" data-emoji-input="" data-autosize="true"></textarea>
    ...
    methods: {
        ...
        selectFile() {
            ...
            file_input.addEventListener('change', () => {
                ...
                this.attachment = file_input.files[0];
                this.sendMessage();
            });
            file_input.click();
        }
