    ...
    <div class="chat-body hide-scrollbar flex-1 h-100">
        <div class="chat-body-inner">
            <div class="py-6 py-lg-12" id="chat-body">
                <div v-for="message in $root.messages" v-bind:key="message.id" class="message" :class="{ 'message-out' : message.user_id == $root.user_id }">
                    ...
                    <div class="message-inner">
                        <div class="message-body">
                            <div class="message-content">
                                ...
                                <div class="message-gallery" v-if="message.type == 'attachment' && message.body.mime_type.match(/image\/.+/)">
                                    <div class="row gx-3">
                                        <div class="col">
                                ...
                                <div class="message-text" v-if="message.type == 'attachment' && !message.body.mime_type.match(/image\/.+/)">
                                    <div class="row align-items-center gx-4">
                                        ...
                                        <div class="col overflow-hidden">
                                            <h6 class="text-truncate text-reset">
                                                <a v-bind:href="'/storage/'+ message.body.file_path" class="text-reset">{{ message.body.file_name }}</a>
                                            </h6>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center text-danger" href="#">
                                                    <span class="me-auto" @click.prevent="$root.deleteMessages(message)">Delete</span>
                                                    <div class="icon">
...
export default {
    ...
    updated() {
        if(this.conversation && this.conversation.id != this.currentConversation){
            fetch(`api/conversations/${this.conversation.id}/messages`)
                .then(response => response.json())
                .then(json => {
                    this.$root.messages = json.messages.data.reverse();
                    this.currentConversation = this.conversation.id;
                    let container = document.querySelector('#chat-body');
                    container.scrollTop = container.scrollHeight;
                })
        }
